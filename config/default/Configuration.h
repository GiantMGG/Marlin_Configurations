...
#define STRING_CONFIG_H_AUTHOR "(Max, Ender-5)" // Who made the changes.
...
#define MACHINE_UUID "6603b835-178c-4eb3-9026-d27d8d93b8de"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.12, 80.28, 800, 400 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.27 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -10, -2.08 } //Z offset mit M401 bestimmt
